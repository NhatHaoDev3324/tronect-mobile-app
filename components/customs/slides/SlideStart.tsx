...
export default function SlideStart() {
    ...
    return (
        <View className="flex-1 flex-col items-center" style={{ paddingTop: inset.top + 80, backgroundColor: "#fff" }}>
            <Image
                source={require("@/assets/images/slides/slide4.png")}
                ...
                <View className="flex-col justify-center mt-8 items-center">
                    ...
                    >
                        <Text className="text-sm text-muted-foreground">
                            Đã có tài khoản? <Text className="text-[#2baf90] font-medium underline">Đăng nhập</Text>
                        </Text>
                    </Pressable>
                </View>
