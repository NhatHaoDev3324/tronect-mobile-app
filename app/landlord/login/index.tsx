...
import { landlordLoginWithEmail, landlordMyProfile } from "@/api/authLandlordApi";
...
export default function LoginScreen() {
    ...
    const onLogin = async () => {
        ...
        setLoading(true);
        try {
            const result = await landlordLoginWithEmail(email.trim(), password);
            ...
            const res = await landlordMyProfile();
                ...
                >
                    <View className="flex flex-col gap-4 items-center justify-center">
                        <Image
                            ...
                            contentFit="contain"
                        />
                        <Text className="text-center text-muted-foreground w-60">
                            Đăng nhập vào tài khoản Tronect với vai trò là Chủ trọ
                        </Text>
                    </View>
                    ...
                    <View className="mt-2 items-end">
                        <Pressable hitSlop={10} onPress={() => router.push("/landlord/forgot-password")}>
                    ...
                    <View className="mt-6 flex-row justify-center gap-2">
                        ...
                        <Pressable hitSlop={10} onPress={() => router.push("/landlord/register")}>
