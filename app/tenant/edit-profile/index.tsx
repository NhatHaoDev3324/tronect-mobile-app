...
import { landlordMyProfile, landlordUpdate, landlordUpdateAvatar } from "@/api/authLandlordApi";
    ...
    const onRefresh = async () => {
        try {
            ...
            if (role === "tenant") {
                ...
                setUrlImg((landlord as any)?.picture);
                hydrateForm(landlord);
            }
        } catch (e: any) {
            Toast.show({
                type: "error",
                            ...
                            >
                                <StatusDropdown
                                    data={[
                                        ...
                                        { label: "Không muốn chia sẻ", value: "no_share" },
                                    ]}
                                    value={data.gender}
                                            ...
                                            >
                                                <Pressable onPress={() => {
                                                    if (dobDate) {
                                                        setData((p) => ({
                                                            ...p,
                                                            date_of_birth: dobDate as any,
                                                        }));
                                                    }
                                                    setShowDobPicker(false);
                                                }}>
                                                    <Text style={{ fontWeight: "700", color: "#2baf90" }}>Xong</Text>
                                                </Pressable>
                                            </View>
