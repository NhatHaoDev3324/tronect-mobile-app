...
export const landlordRegister = async (
  username: string,
  email: string,
  phone: string,
  password: string,
) => {
  const request = await api.post("/api/landlord/register", {
    username,
    email,
    phone,
    password,
...
export const landlordRegisterSendOtp = async (
  typeContact: string,
  contact: string,
) => {
  const request = await api.post("/api/landlord/send-otp", {
    typeContact,
    contact,
  });
  return request.data;
...
export const landlordRegisterByPhone = async (
  username: string,
  phone: string,
  password: string,
  otp: string,
) => {
  const request = await api.post("/api/landlord/register-by-phone", {
    username,
    phone,
    password,
    otp,
...
export const landlordLoginWithEmail = async (
  email: string,
  password: string,
) => {
  const request = await api.post("/api/landlord/login/email-no-captcha", {
    email,
    password,
  });
  return request.data;
...
export const landlordLoginWithPhone = async (
  phone: string,
  password: string,
) => {
  const request = await api.post("/api/landlord/login/phone", {
    phone,
    password,
  });
  return request.data;
...
export const landlordResetPassword = async (
  token: string | null,
  newPassword: string,
) => {
...
export const landlordUpdate = async (
  username: string,
  email: string,
  phone: string,
  gender: string,
  ...
  const request = await api.put("/api/landlord/update", {
    username,
    email,
    phone,
    gender,
...
export const landlordUpdatePass = async (
  oldPassword: string,
  newPassword: string,
) => {
  const request = await api.put("/api/landlord/update/pass", {
    oldPassword,
    newPassword,
  });
  return request.data;
...
export const ResetPassLandlord = async (id: string, newPassword: string) => {
  const request = await api.post("/api/landlord/resetPass", {
    id,
    newPassword,
  });
  return request.data;
